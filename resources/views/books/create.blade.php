            ...
            <div class="flex flex-col md:flex-row items-end justify-between mb-12 border-b border-gray-100 pb-6">
                <div>
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="font-mono text-xs font-medium text-gray-500 uppercase tracking-widest">New Entry</span>
                    </div>
                    ...
                    <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        @if ($errors->any())
                            <div class="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-lg text-sm">
                                <strong class="font-bold block mb-1">Ada masalah pada input:</strong>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <input type="text" name="writer" x-model="bookWriter"
                                        class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all" 
                            ...
                            <div class="grid grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <input type="number" name="publication_year" x-model="bookYear"
                                        class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all" 
                                        placeholder="2024" required>
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Stok Awal</label>
                                    <div class="relative">
                                ...
                                <label class="block w-full group cursor-pointer">
                                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg group-hover:border-black group-hover:bg-gray-50 transition-all">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="text-sm font-bold text-gray-900">Upload Cover Image</p>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-24 space-y-4">
                        <div class="flex items-center justify-between">
                            <span class="font-mono text-xs font-bold text-gray-400 uppercase tracking-widest">Entry Preview</span>
                            <span class="flex items-center gap-1.5 px-2 py-1 bg-gray-50 border border-gray-200 rounded text-[10px] font-bold text-gray-500 uppercase">
                                <span class="w-1.5 h-1.5 bg-amber-400 rounded-full animate-pulse"></span> Draft
                            </span>
                        </div>

                        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                            <div class="aspect-[3/4] bg-gray-100 relative border-b border-gray-100 overflow-hidden">
                                ...
                                <template x-if="!photoPreview">
                                    <div class="w-full h-full flex flex-col items-center justify-center text-gray-300">
                                        ...
                                        <span class="font-mono text-[10px] uppercase">No Cover Selected</span>
                                    </div>
                                </template>
                            </div>
                            
                            <div class="p-5">
                                <h2 class="text-xl font-bold text-gray-900 leading-tight mb-1" x-text="bookTitle || 'Untitled Book'"></h2>
                                <p class="text-sm text-gray-500 mb-4" x-text="bookWriter || 'Unknown Author'"></p>
                                ...
                                <div class="grid grid-cols-2 gap-2 border-t border-gray-100 pt-4">
                                    <div>
                                        ...
                                        <span class="text-xs font-bold text-gray-900 truncate block" x-text="bookPublisher || '-'"></span>
                                    </div>
                                    <div>
                                        <span class="block text-[10px] text-gray-400 font-mono uppercase">Year</span>
                                        <span class="text-xs font-bold text-gray-900" x-text="bookYear || '-'"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
